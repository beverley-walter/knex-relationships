  ...
  return knex('profile').del()
    .then(function () {
      return Promise.all([
        ...
        knex('profile').insert({id: 4, url: 'https://en.wikipedia.org/wiki/Duck', photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Tunnel_of_ducks.jpg/1200px-Tunnel_of_ducks.jpg', info: 'My favourite food is weeds', user_id:99904}),
        knex('profile').insert({id: 5, url: 'https://en.wikipedia.org/wiki/Elephant', photo: 'https://aos.iacpublishinglabs.com/question/aq/1400px-788px/how-fast-can-an-elephant-run_4a36d683-3805-4826-a9ce-e1f561dac754.jpg?domain=cx.aos.ask.com', info: 'My favourite food is grass', user_id:99905}),
